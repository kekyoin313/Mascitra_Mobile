...
class _PilihTanggalScreenState extends State<PilihTanggalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          // Header - menggunakan asset yang sama dengan PilihTanggalPage
          Container(
          ...
          // Tanggal Mulai - menggunakan warna yang sama dengan PilihTanggalPage
          GestureDetector(
          ...
          // Tanggal Berakhir - menggunakan warna yang sama dengan PilihTanggalPage
          GestureDetector(
